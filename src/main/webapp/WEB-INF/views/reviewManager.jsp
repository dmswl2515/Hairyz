						...
						<table
							...
							<tbody>
								<c:choose>
									...
									<c:otherwise>
										<c:forEach var="rm" items="${reviewManager}"
											varStatus="status">
											<c:if test="${rm.pr_visibility == 'Y'}">
												<tr style="cursor: pointer;"
													onclick="window.open('reviewReply.do?reviewId=${rm.pr_reviewId}&reviewDate=${rm.pr_reviewDate}&mbName=${rm.pr_MbNnme}&reviewText=${rm.pr_reviewText}', '_blank', 'width=700, height=600, top=50, left=50, scrollbars=yes')">
						...
						<nav aria-label="Page navigation example">
							<ul class="pagination justify-content-center">
								...
								<li
									...
									onclick="navigateToPage(${currentPage - 1})"> <span
