...
| `목록`            | `내용`                                                                                                          |
|     :---:        | ---------------------------------------------------------------------------------------------------------------|
| `작업기간`         | `2024.09.23 – 2024.10.18(총 4 주)`                                                                              |
| `기여도`          | `쇼핑 관련 페이지(개인 100%)`<br>  `관리자 페이지(50%)`<br> `API 적용(80%)`                                              |
...
|        :---:        | ---------------------------------------------------------------------------------------------|
| `OS`                | `Windows10` `Mac Os`                                                                         |
| `Language & Etc`    | `JAVA` `SQL` `HTML` `CSS` `JS` `Python` `Pandas` `Matplotlib` `JSP` `jQuery`                 |
| `DataBase`          | `Oracle`                                                                                     |
| `Develop Tool`      | `Spring Tools4` `SQL Developer` `docker` `DBeaber`                                           |
| `API`               | `Kakao developers` `Google Developers` `facebook API` `Geolocation` `bootpay`                |
| `Version control`   | `GitHub` `SourceTree`                                                                        |
| `Collaborative Tool`| `Trello`                                                                                     |
